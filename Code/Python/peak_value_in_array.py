...
An array element is a peak if it is NOT smaller than its neighbours. For corner elements, we need to consider only one neighbour. There might be multiple peak elements in an array and the solution should report any peak element.
